...
import com.project.template.module.chat.pojo.bo.BaiduErnieMessage;
import com.project.template.module.chat.serivice.AiChatInterface;
...
public class BaiduErnieImpl implements AiChatInterface {
    ...
    @Value("${baidu.chat.api-key}")
    private String apiKey;

    @Value("${baidu.chat.secret-key}")
